...
const PickupChat = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-12 bg-gray-900 text-white p-6 rounded-lg shadow-xl flex flex-col md:flex-row w-full h-[85vh]">
      
      {/* ✅ Sidebar: Threads List */}
      <aside className="w-full md:w-1/3 p-6 border-r border-gray-700 relative">
